...
>Dr Ricker talked about the power of maps and how they offer the users more knowledge which in return giving better decisions. She made a point that there are lots of volunteer data being generated (OSM) but all in vector data and not in raster. How project like OpenAerialMap (OAM)[https://openaerialmap.org/]can help bring together raster data to people. Getting right kind of data to right people, use of robots to gather data in the air, underwater, in disaster area then able to share with experts are invaluable. [Robin Murphy, TED 2015](https://www.ted.com/talks/robin_murphy_these_robots_come_to_the_rescue_after_a_disaster?language=en#t-501056)
...
>Mix of advance technology + remote areas gives problems. POSM was deployed in West Africa to collect spatial data. It covered 5000 villages over 37,000 km2 (14,000 square miles) in 4 months.
